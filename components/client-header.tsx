      ...
      <div className="max-w-7xl mx-auto px-4 h-full">
        <div className="flex items-center h-full gap-4">
          ...
          <div className="flex-1 max-w-md hidden sm:block">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-muted border-0 rounded-full h-9"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 ml-auto">
            {/* Test Mode Badge */}
            {session.isTestMode && (
              <span className="hidden sm:inline-flex items-center px-2 py-1 rounded-md bg-yellow-100 text-yellow-800 dark:bg-yellow-950/80 dark:text-yellow-200 text-xs font-medium">
                Modo prueba
              </span>
            )}
            ...
            <div className="hidden md:block text-right">
              ...
              <p className="text-xs text-muted-foreground">RUT: {session.rut}</p>
            </div>
